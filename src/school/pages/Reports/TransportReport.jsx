        ...
        <div className="rpt-report-page">
            ...
            <div className="rpt-row rpt-row-2" style={{ marginBottom: '20px' }}>
                <div className="rpt-card">
                    <div className="rpt-card-header"><h5 className="rpt-card-title">Students by Route</h5></div>
                    <div className="rpt-chart-body">
                        <ResponsiveContainer width="100%" height={200}>
                            <BarChart data={[
                                { route: 'Route A', students: 120 },
                                { route: 'Route B', students: 85 },
                                { route: 'Route C', students: 65 },
                                { route: 'Route D', students: 110 }
                            ]}>
                                <CartesianGrid strokeDasharray="3 3" vertical={false} stroke="#f0f0f0" />
                                <XAxis dataKey="route" axisLine={false} tickLine={false} tick={{ fontSize: 11 }} />
                                <YAxis axisLine={false} tickLine={false} tick={{ fontSize: 11 }} />
                                <Tooltip />
                                <Bar dataKey="students" fill="#ff9f43" radius={[4, 4, 0, 0]} />
                            </BarChart>
                        </ResponsiveContainer>
                    </div>
                </div>
                    ...
                    <div className="rpt-chart-body rpt-chart-center">
                        <ResponsiveContainer width="100%" height={180}>
                            <PieChart>
                                <Pie
                                    data={[
                                        { name: 'Paid', value: 32, color: '#28c76f' },
                                        { name: 'Pending', value: 8, color: '#ea5455' }
                                    ]}
