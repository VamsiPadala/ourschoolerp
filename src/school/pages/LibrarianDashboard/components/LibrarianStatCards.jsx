...
import { IconBooks, IconBookUpload, IconBookDownload, IconAlertTriangle } from '@tabler/icons-react';

const STATS = [
    { label: 'Total Books', value: '8,432', change: '+24', sub: 'in collection', icon: IconBooks, color: '#3D5EE1', bg: '#eef2ff', gradient: 'linear-gradient(135deg,#3D5EE1,#6C49EF)' },
    { label: 'Books Issued', value: '364', change: '+18', sub: 'currently out', icon: IconBookUpload, color: '#10b981', bg: '#d1fae5', gradient: 'linear-gradient(135deg,#10b981,#059669)' },
    { label: 'Returned Today', value: '47', change: '+11', sub: 'books today', icon: IconBookDownload, color: '#f59e0b', bg: '#fef3c7', gradient: 'linear-gradient(135deg,#f59e0b,#d97706)' },
    { label: 'Overdue Books', value: '28', change: '-6', sub: 'need follow-up', icon: IconAlertTriangle, color: '#ef4444', bg: '#fee2e2', gradient: 'linear-gradient(135deg,#ef4444,#dc2626)' },
];

const LibrarianStatCards = () => (
...
export default LibrarianStatCards;
