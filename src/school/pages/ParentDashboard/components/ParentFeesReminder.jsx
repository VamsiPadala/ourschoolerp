...
const FEES = [
    ...
    { label: 'Mess Fees Due', amount: '$2,500 + $150', due: 'OVERDUE', icon: IconAlertCircle, color: '#ef4444', bg: '#fee2e2', overdue: true },
    { label: 'Hostel Fees', amount: '$2,500', due: '25 May 2024', icon: IconBuildingBank, color: '#8b5cf6', bg: '#ede9fe', overdue: false },
];

const ParentFeesReminder = () => (
    <div style={{ background: 'white', borderRadius: 16, boxShadow: '0 4px 24px rgba(0,0,0,0.06)', border: '1px solid #f1f5f9', overflow: 'hidden' }}>
        <div style={{ padding: '16px 20px', borderBottom: '1px solid #f1f5f9', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                ...
                <span style={{ fontWeight: 700, fontSize: 16, color: '#1e1b4b' }}>Fees Reminder</span>
            </div>
...
export default ParentFeesReminder;
