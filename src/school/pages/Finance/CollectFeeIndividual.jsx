                ...
                <div className="cfi-right">
                    ...
                    <div className="cfi-card payment-form-card">
                        ...
                        <div className="multi-pay-form">
                            ...
                            {/* Payment Meta */}
                            <div style={{ display: 'grid', gridTemplateColumns: 'minmax(240px, 1.5fr) minmax(180px, 1fr)', gap: '1.25rem', marginTop: '1.25rem', alignItems: 'flex-start' }}>
                                    ...
                                    <div className="method-grid">
                                        {['Cash', 'Bank', 'Card'].map(m => (
                                            <button key={m}
                                                ...
                                                {m === 'Cash' && <IconCash size={18} />}
                                                {m === 'Bank' && <IconBuildingBank size={18} />}
                                                {m === 'Card' && <IconCreditCard size={18} />}
