...
import {
    ...
    IconArchive, IconAffiliate, IconVideo, IconMessages, IconTarget
...
const PATH_TO_PERMISSION_ID = {
    ...
    '/school/pro-dashboard': 'dashboard_overview',
    ...
    '/school/campaign/manage': 'admission_enquiry',
    '/school/campaign/my-campaigns': 'admission_enquiry',
};
/**
        ...
        items: [
            {
                ...
                subItems: [
                    ...
                    { title: 'PRO Dashboard', path: '/school/pro-dashboard' },
                ]
            },
            {
    ...
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                subItems: [
                    { title: 'Certificate Templates', path: '/school/certificates/templates' },
                    { title: 'Generate Document', path: '/school/certificates/generate' }
                ]
            },
            {
                title: 'Communicate',
            ...
            },
            {
                ...
                icon: IconTarget,
                subItems: [
                    { title: 'Manage Campaigns', path: '/school/campaign/manage' },
                    { title: 'My Campaigns', path: '/school/campaign/my-campaigns' }
                ]
            },
            {
                title: 'Library',
            ...
            },
            {
                ...
                icon: IconPackage,
                subItems: [
                    { title: 'Issue Item', path: '/school/inventory/issue-item' },
                    { title: 'Add Stock', path: '/school/inventory/add-stock' },
                    { title: 'Item List', path: '/school/inventory/items' },
                    { title: 'Item Categories', path: '/school/inventory/categories' },
                    { title: 'Suppliers', path: '/school/inventory/suppliers' },
                    { title: 'Reports', path: '/school/inventory/reports' }
                ]
            },
            {
                title: 'Transport',
